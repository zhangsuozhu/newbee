defmodule Newbee.Colony.Engine do
  ...
  # 已解散的蜂群只保留记录，不再对外提供协作视图。
  defp ensure_active(%{"status" => "dissolved"}), do: {:error, "dissolved", "蜂群已解散"}
  defp ensure_active(_colony), do: :ok
  ...
  defp resolve_task_bee(_colony, task) do
